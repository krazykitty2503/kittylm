...
The tables below cover KittyLM's direct runtime and development dependencies. Transitive
dependencies are not exhaustively listed here; their licenses remain governed by their
respective distributions.

License identifiers below are the SPDX expressions or package metadata declared by each
package in the development environment for the versions shown. Consult each project for its
...
| ----------------- | --------------------------------------------------------- | --------------------------------------------------------------------------------------------------- |
| PyTorch (`torch`) | 2.13.0+rocm10.0.0 (local ROCm build; CI uses a CPU build) | Apache-2.0 AND Apache-2.0 WITH LLVM-exception AND BSD-2-Clause AND BSD-3-Clause AND BSL-1.0 AND MIT |
...
| `CODE_OF_CONDUCT.md` | Contributor Covenant 2.0, via the GitHub codes-of-conduct API  | CC BY 4.0  |
